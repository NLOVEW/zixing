    ...
    <div>
      <form method="post" id="submit_form">
        ...
        <div id="code">
          ...
          <!--验证码区域-->
          <img id="img_verify" src="/zixing/admin.php/Home/Index/verify" title="点击刷新" alt="验证码图"/>
        </div>
        <div id="remember">
...
<script type="text/javascript">
  function check() {
      ...
      if(username==''){
          ...
          document.getElementById("submit_form").action="/zixing/admin.php/Home/Home/index";
      }
  }
</script>